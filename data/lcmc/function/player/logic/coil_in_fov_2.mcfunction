...
execute as @e[tag=FOVMarker] if score @s lcmc.player.moddedFacing.Y matches -45..45 if score @s lcmc.player.moddedFacing.X matches -55..55 run scoreboard players set @e[tag=CurrentCoil] lcmc.coilhead.inFOV 1
...
execute if score @s lcmc.coilhead.inFOV matches 1 as @e[tag=FOVMarker] at @s run function lcmc:enemy/coilhead/raycast
