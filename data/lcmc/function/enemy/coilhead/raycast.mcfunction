execute if score .hit lcmc.player.logic.raycast matches 0 positioned ~-0.05 ~-0.05 ~-0.05 as @e[tag=lcmc.entity.logic.CurrentCoil,dx=0.1,sort=nearest] run function lcmc:enemy/coilhead/visible
