...
data merge entity @s {HandItems:[{},{}],ArmorItems:[{},{},{},{}],Silent:1b,Invulnerable:1b,PersistenceRequired:1b,Tags:["CoilHeadRoot","Enemy"],attributes:[{id:"minecraft:generic.attack_speed",base:.2},{id:"minecraft:generic.movement_speed",base:0.75}]}
