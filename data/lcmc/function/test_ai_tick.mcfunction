...
kill @e[tag=lcmc.entity.test.MotionVector]
...
execute store result entity @s Motion[0] double 1 positioned 0 0 0 run data get entity @n[tag=lcmc.entity.test.MotionVector] Pos[0]
execute store result entity @s Motion[2] double 1 positioned 0 0 0 run data get entity @n[tag=lcmc.entity.test.MotionVector] Pos[2]
